...
knit: (function(input_file, encoding) {
 ...
 encoding=encoding,
 output_file=file.path(dirname(input_file), out_dir, 'CoC_doc.html'))})
author: "Bioconductor Code of Conduct Committee"
date: "`r format(Sys.time(), '%d %B, %Y')`"
output: html_document
---

## Version 1.0.3 (March 6, 2022)
...
We understand that you may want an impartial person overseeing your conflict resolution. To facilitate this, the Code of Conduct Committee will appoint an Ombudsperson from a different open source community than members of the Bioconductor project. While they do not have power to establish, change or set aside decision's made by the Code of Conduct Committee, they can assist community members by offering consultation, mediation, coaching and referrals to other 
...
* Yagoub Adam yagoub@alumni.usp.br (until 2022) he/him [EN]
* Leonardo Collado-Torres lcolladotor@gmail.com (until 2022) he/him [EN, ES]
* Laurent Gatto laurent.gatto@gmail.com (until 2023) he/him [EN, FR]
* Michael Love michaelisaiahlove@gmail.com (until 2024) he/him [EN]
...
* Johannes Rainer johannes.rainer@eurac.edu (until 2023) he/him [EN, IT]
* Lluís Revilla lluis.revilla@gmail.com (until 2024) he/him [CAT, ES, EN]
* Kevin Rue-Albrecht (until 2024) he/him [FR, EN]
* Charlotte Soneson charlottesoneson@gmail.com (until 2023) she/her [EN, SE]
* (Ombusdperson) Beatrix Serrano-Solano beatrizserrano.galaxy@gmail.com (Galaxy project) she/her 
